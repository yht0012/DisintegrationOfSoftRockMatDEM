...
clear;
r=20;%radius of element, in this example, it is between 5-20 m
...
save('slope/slopeSurface2.mat','S_bot','S_top','S_top0','S0','S1','S2','S_source','r');
%colorbar
fs.general3Dset();